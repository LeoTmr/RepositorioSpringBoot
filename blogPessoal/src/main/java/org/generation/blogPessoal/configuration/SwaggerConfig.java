...
.title("Blog Pessoal Leonardo Trotta")
.description("Projeto API - Blog Pessoal")
.version("1.0.0")
.license("Apache License Version 2.0")
.licenseUrl("https://github.com/LeoTmr")
.contact(contact())
.build();
}
private static Contact contact() {
return new Contact("Leonardo Trotta",
"https://github.com/LeoTmr",
"leonardotrotta32@gmail.com");
}
